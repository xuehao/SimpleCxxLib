...
public:
    ...
    std::string openFileDialog(std::string title, std::string mode, std::string path);
    void createGWindow(const GWindow& gw, double width, double height, GObject* topCompound);
    ...
    void setRegionAlignment(const GWindow& gw, std::string region, std::string align);
    void addToRegion(const GWindow& gw, GObject* gobj, std::string region);
    void removeFromRegion(const GWindow& gw, GObject* gobj, std::string region);
    ...
    void createGRoundRect(GObject* gobj, double width, double height, double corner);
    ...
    void createGArc(GObject* gobj, double width, double height, double start, double sweep);
    ...
    void setFrameRectangle(GObject* gobj, double x, double y, double width, double height);
