...
private:
    const GObject& operator=(const GObject& src) {
        return *this;
    }
...
public:
     ...
     * (<code>x</code>,&nbsp;<code>y</code>), leaving the end point unchanged.
     * This method is therefore different from <code>setLocation</code>, which
